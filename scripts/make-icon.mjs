...
const svg = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="256" height="256">
  <rect width="256" height="256" rx="48" fill="#1A1A1A" transform="scale(10.667)"/>
  <g fill="none" stroke="#CCCCCC" stroke-width="1.3" stroke-linecap="round" stroke-linejoin="round" transform="translate(2,2)">
...
console.log('✓ public/icon.png generated');
